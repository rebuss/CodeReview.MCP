---
name: self-review
description: Generate an AI-assisted self-review of local git changes (staged, unstaged, or branch-vs-branch) via the REBUSS.Pure MCP server. Triggers when the user asks to review their own work-in-progress, staged changes, uncommitted edits, or a feature branch before opening a PR.
argument-hint: [scope]
---
