...
/// <summary>
/// Default <see cref="IAgentInspectionWriter"/> used when the <c>REBUSS_COPILOT_INSPECT</c>
/// environment variable is unset. Both methods return a completed task synchronously —
/// zero runtime cost. Feature 022.
/// </summary>
internal sealed class NoOpAgentInspectionWriter : IAgentInspectionWriter
{
